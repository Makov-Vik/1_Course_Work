...
const biba = document.getElementById("biba");
const buttonPassword = document.getElementById("button");
const massPassword = document.getElementById("mass-password");
const biba2 = document.getElementById("biba2");
const input2 = document.getElementById("input2");
const buttonCopy = document.getElementById("button2");
